...
// 13. Finally try to use page.lock.install() and page.lock.pauseAt(Date.now()) and page.lock.runFor(10000) to simulate the time passing and accelerate the test
